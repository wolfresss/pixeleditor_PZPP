...
#### 4.2 Program musi umożliwiać: dodawanie warstw, usuwanie warstw, zmianę kolejności warstw, włączanie i wyłączanie widoczności warstw, Użytkownik musi mieć możliwość rysowania tylko na aktywnej warstwie.
